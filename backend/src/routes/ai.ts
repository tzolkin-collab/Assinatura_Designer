...
// Ensures all layer IDs are unique within a slide's layer array.
// AI models sometimes produce duplicate IDs; this appends a counter to resolve collisions.
function deduplicateLayerIds(layers: Layer[]): Layer[] {
...
function ensureTextContrast(layers: Layer[], backgroundColor: unknown): Layer[] {
...
function finalizeSlideContrast<T extends { backgroundColor?: unknown; layers?: Layer[] }>(slide: T): T {
  return {
    ...slide,
