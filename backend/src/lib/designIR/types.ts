// ═══════════════════════════════════════════════════════════════════════════════
// Design IR (Intermediate Representation) — Tipos (cópia canônica do backend)
//
// Espelha frontend/src/lib/designIR/types.ts. Mantido aqui dentro de `src` para
// não violar o rootDir do tsc (o backend não pode importar arquivos .ts fora de
// src no build). Se mudar o schema, atualize os dois lados até existir um pacote
// compartilhado. Veja também [[designer-generation-principles]].
// ═══════════════════════════════════════════════════════════════════════════════
