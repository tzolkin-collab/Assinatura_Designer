...
1a. ÍCONE NÃO SUBSTITUI FOTO. Esta decisão é só sobre a IMAGEM PRINCIPAL do slide. Se o hint pede foto, cena, produto, pessoa ou ambiente, um ícone NÃO serve como resposta, por mais que o tema combine: um "icon-bar-graph-arrow" não atende "foto de equipe comemorando crescimento". Nesses casos escolha "generate-photo" (ou "skip" se estiver desligado), nunca "reuse".
